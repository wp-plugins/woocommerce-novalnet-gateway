 ...
 */
add_action('plugins_loaded', 'init_gateway_'.$novalnet_payment_methods['nn_telephone'], 0);
...
add_filter('woocommerce_payment_gateways', 'add_gateway_'.$novalnet_payment_methods['nn_telephone']);
?>