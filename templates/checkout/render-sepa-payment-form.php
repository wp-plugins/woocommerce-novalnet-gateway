 ...
 */
 ...
 echo '<input type="hidden" id="nn_sepa_tag" value="' .( ! isset( $_SESSION['novalnet']['novalnet_sepa']['tid'] ) ? 1 : 0 ) . '"/>';
  ...
  if ( ! isset( $_SESSION['novalnet']['novalnet_sepa']['tid'] ) ) : ?>
	...
	<p class="form-row form-row-wide">
		<input type="checkbox" id="novalnet_sepa_mandate_confirm" value="1"/><?php echo __('I hereby grant the SEPA direct debit mandate and confirm that the given IBAN and BIC are correct', 'wc-novalnet');?> <span class="required">*</span>
	</p>
